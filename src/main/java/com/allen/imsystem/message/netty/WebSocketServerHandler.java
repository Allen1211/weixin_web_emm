...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        if (!hasChannelExist && uid != null) {
            redisService.hset(GlobalConst.RedisKey.KEY_USER_STATUS, uid, GlobalConst.UserStatus.OFFLINE);
        }
        if (removeSuccess) {
...
//        }
        ...
        // 更新用户登录状态
        redisService.hset(GlobalConst.RedisKey.KEY_USER_STATUS, uid, GlobalConst.UserStatus.ONLINE);
        return;
    }
